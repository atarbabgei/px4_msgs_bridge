...
configurable_parameters = [
    ...
    {'name': 'external_joint_name',                    'default': '',         'description': 'Joint name to look for in external topic (e.g., joint_0, propeller_guard_joint). Empty = use bridge_config.yaml'},
...
def launch_bridge_node(context, *args, **kwargs):
    ...
    param_mapping = {
        ...
        'external_joint_name': 'px4_to_ros.external_joint_name',
